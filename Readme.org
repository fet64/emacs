...
* Do this first - Five (5) easy steps
** 0 - Zero, set your variables
Enter your settings in this code block. These are used on various places in this configuration. I use a MacBook with the hostname =au= or a Linux machine with hostname =box=. After editing these settings you can run this code block ~(C-c C-c)~ to set your settings.
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Fet64"                                     ;; My full name
		user-mail-address "fet64@outlook.com")                     ;; My email-address
  (defvar macbook-p (equal (system-name) "au")                     "If true, I'm using my Macbook")
  (defvar linux-p (equal (system-name) "box")                      "If true, I'm using my Linux box")
  (defvar fet/home (concat (getenv "HOME") "/")                    "User home directory.")
  (defvar fet/emacs (concat fet/home ".config/emacs/")             "Directory for emacs configuration files")
  (defvar fet/org (concat fet/home "Org")                          "Directory for org files")
  (defvar fet/emacs-personal (concat fet/home "emacs-personal")    "Directory for personal emacs/lisp files")
  (defvar fet/scripts (concat fet/emacs "scripts")                 "Directory for supporting scripts")
  (defvar fet/snippets (concat fet/emacs "snippets")               "Directory for snippets")
  (defvar fet/images (concat fet/emacs "images")                   "Directory for images")
  (defvar fet/backups (concat fet/emacs "backups")                 "Directory for backups")
  (defvar fet/auto-save-list (concat fet/emacs "auto-save-list")   "Directory for auto-save-list")
  ...
  (setq-default fet/default-line-spacing 0)                        ;; don't know why I do this but it seems to work...
#+END_SRC
...
Add search path to ~early-init.el~.
#+BEGIN_SRC emacs-lisp :tangle "~/.config/emacs/early-init.el"
  (exec-path)
  (setenv "PATH" (concat (getenv "PATH") ":/Library/TeX/texbin/"))
#+END_SRC
* Files, registers and variables
** Variables and directory paths used in this config
Setting variables to be used in this configuration setup.
#+BEGIN_SRC emacs-lisp :var emacs-home=(ot variables $emacs-home-dir)
  ;;; fet-variables
...
#+END_SRC
** Load local scripts
TODO add other scripts here and tangle to different places and files
#+begin_src emacs-lisp 
...
Generaly you should not put GUI things in ~early-init.el~ that belong in ~init.el~. But I *like* this.
#+begin_src emacs-lisp :tangle "~/.config/emacs/early-init.el"
  (tool-bar-mode -1)
  (scroll-bar-mode -1)
...
*** Backups
TODO should use path set in variable 
#+begin_src emacs-lisp 
  ;; Backup
...
#+END_SRC
*** Trash
TODO check if darwin, otherwise use different path
#+BEGIN_SRC emacs-lisp
  ;; Trash
...
This config is for mac os only, fix for linux
...
#+END_SRC
*** TODO Tags, Todos and priorities
#+BEGIN_SRC emacs-lisp
...
*** Path
#+BEGIN_SRC emacs-lisp
  (defvar my-agenda-files '("inbox.org" "projects.org" "habits.org" "agenda.org" "read.org" "todo.org"))
