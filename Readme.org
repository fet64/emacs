...
#+begin_src emacs-lisp
  ...
  (transient-define-prefix fet-config-command ()
	...
	[["Configuration files"
	 ...
	 ["Theme options"
	  ("l1" "doom-solarized-light" (lambda () (interactive) (fet/load-theme 'doom-solarized-light)))
	  ("d1" "doom-one" (lambda () (interactive) (fet/load-theme 'doom-one)))
	  ("l2" "tango" (lambda () (interactive) (fet/load-theme 'tango)))
	  ("l3" "leuven" (lambda () (interactive) (fet/load-theme 'leuven)))
	  ("l3" "leuven" (lambda () (interactive) (fet/load-theme 'leuven)))
	  ]
	 ])

  (fet/load-theme 'doom-one)
  ;;(fet-config-command)
