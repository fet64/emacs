...
| images/transient-help.png             | -> | /Users/au/.config/emacs/images/transient-help.png             |
| images/melpa.png                      | -> | /Users/au/.config/emacs/images/melpa.png                      |
| images/transient-base.png             | -> | /Users/au/.config/emacs/images/transient-base.png             |
| images/emacs.png                      | -> | /Users/au/.config/emacs/images/emacs.png                      |
| images/which-key.png                  | -> | /Users/au/.config/emacs/images/which-key.png                  |
| images/general.png                    | -> | /Users/au/.config/emacs/images/general.png                    |
...
#+RESULTS:
| ~/.config/emacs/lisp/scripts.el | ~/.config/emacs/lisp/package-manager.el | ~/.config/emacs/early-init.el | ~/.config/emacs/init.el |
...
#+begin_src emacs-lisp :tangle "~/.config/emacs/lisp/scripts.el"
  ...
  ;; kill other buffers
  (defun fet/kill-other-buffers ()
    "Kill all other buffers."
    (interactive)
    (mapc 'kill-buffer (delq (current-buffer) (buffer-list))))

  ;; kill all dired buffers
  (defun fet/kill-dired-buffers ()
  ...
  ;; pwgen
  (defun fet/generate-password ()
    "Generate and insert a new password."
    (interactive)
    (insert
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq user-mail-address "fet64@outlook.com"
        user-full-name "Fet64")
  (setq gnus-select-method
        '(nnimap "my_mail"
                 (nnimap-address "outlook.live.com")
  ...
  (setq smtpmail-stream-type 'ssl
        smtpmail-smtp-server "outlook.live.com"
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "M-<down>") 'fet/move-line-down)
  (global-set-key (kbd "M-<up>") 'fet/move-line-up)
...
#+begin_src emacs-lisp
  ...
  ;;	("b" "Show bindings" counsel-bindings)
     ...
     ["Online"
      ("ho" "Browse orgmode.org" (lambda () (interactive)(browse-url "https://orgmode.org")))
      ("he" "Browse Emacs manual" (lambda () (interactive)(browse-url "https://www.gnu.org/software/emacs/manual/html_node/emacs/index.html")))
  ...
  (transient-define-prefix tdp-themes ()
    ...
    :transient-suffix 'transient--do-stay
     [["Dark themes"
       ("0" "Choose from all themes" fet-load-theme)
  ...
  (transient-define-prefix fet-space-command ()
    ...
    [
     ["Commands"
      ...
      ("P" "Generate and insert password" fet/generate-password)
      ]
