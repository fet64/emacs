...
#+begin_src emacs-lisp
  ...
  (transient-define-prefix fet-config-command ()
	...
	[["Emacs"
	  ...
	  ("gg" "Git status" magit-status)
	  ("S" "Insert snippet" yas-insert-snippet)
	  ("T" "Org babel tangle" org-babel-tangle)
	  ("E" "Export dispatch" org-export-dispatch)
	  ("c" "Org capture" org-capture)
  ;;	("x" "Change theme" tdp-theme )
	  ("q" "Cancel" (lambda () (interactive)(message "Cancel")))
	  ]

	 ["Buffer"
	  ("i" "Ibuffer" ibuffer)
	  ("bb" "Switch to buffer" switch-to-buffer)
	  ("bk" "Kill current buffer" kill-current-buffer)
	  ("bP" "Print buffer" lpr-buffer)
	  ]
	 ...
	 ["Theme options"
	  ("1" "doom-solarized-light" (lambda () (interactive) (fet/load-theme 'doom-solarized-light)))
	  ("2" "doom-one" (lambda () (interactive) (fet/load-theme 'doom-one)))
	  ("3" "tango" (lambda () (interactive) (fet/load-theme 'tango)))
	  ("4" "leuven" (lambda () (interactive) (fet/load-theme 'leuven)))
	  ("5" "leuven" (lambda () (interactive) (fet/load-theme 'leuven)))
	  ]
	 ]
  ...
  (autoload 'tdp-theme "tdp-theme" "Change theme" t)

  ;;;###autoload (autoload 'tdp-theme "tdp-theme" nil t)
  (transient-define-prefix tdp-theme ()
	"Switch theme"
	(setq choosen-theme 'doom-one)
	["Arguments"
	 ("-l" "doom-solarized-light" (nil "--doom-solarized-light"))
	 ("-d" "doom-one" (nil "--doom-one"))
	 ]
	["Change theme"
	 ("c" (lamda () (interactive) (message "Theme choosen")))
	 ]
	)
#+end_src
