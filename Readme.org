...
#+language: en
#+options: ':t toc:4 author:t email:t num:t
...
- [[#macos-keyboard-configuration][MacOS Keyboard Configuration]]
...
- [[#registers][Registers]]
- [[#backups-history-and-trash][Backups, history and trash]]
...
- [[#evil-mode][Evil mode]]
- [[#hydras][Hydras]]
  - [[#hydra-window-movement][Hydra window movement]]
- [[#magit][Magit]]
- [[#org][Org]]
- [[#themes-and-visual-stuff][Themes and visual stuff]]
  - [[#all-the-icons][All the icons]]
  - [[#doom-theme-and-modeline][Doom theme and modeline]]
- [[#general-settings-gui-and-sane-defaults][General Settings (GUI and sane defaults)]]
